...
```{r}
# Create data series with policy A scenarios
waming <- warming %>% 
  mutate(warming_baseline_x1.5 = warming_baseline*1.5) #%>% 
#  mutate(damages_baseline_x1.5 = damages_baseline*1.5) ## not sure on this
# I think we need to use our estimated damages function from Q1 to find new damages with new warming x1.5 data
...
# Calculate expected value of damages for policy A
# policy_A_expected_value <- (PV_A_baseline * 0.5) + (PV_A_baseline_x1.5 * 0.5)

```

Under Policy A, the expected present value of damages up to 2100 is ....
...
Under Policy B, the expected present value of damages up to 2100 is ....
