...
If society were risk averse, then Policy B would be still be more attractive than Policy A because the expected value of Policy B is certain while the expected value of Policy A is uncertain (2 possible scenarios).
